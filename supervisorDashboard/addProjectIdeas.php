	<form class="needs-validation" action="../sql/addProjectIdeas.php" method="post" novalidate>
		<div class="form-row">
			<div class="col-md-4 mb-3">
				<label class="h3" for="firstName">Project Ideas</label>
		...
		<div class="form-row">
			<div class="col-md-4 mb-3">
				<label class="h3" for="firstName">Project Interests</label>
				<p>Please enter upto 10 keywords E.g Security, AI, Java</p>
				<p>One keyword per box</p>
		...
		<button class="btn btn-primary" type="submit">Add Project ideas</button>
	</form>
